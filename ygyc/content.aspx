...
<body style="margin: 0; min-width: 1200px;font-family:'微软雅黑'">
    <form id="form1">
        ...
        <div class="middle">
<div class="location">当前位置 > <a href="http://www.910class.com/ygyc/index.aspx">首页</a> > <a href="http://www.910class.com/ygyc/product.aspx?channel=goods">培训课程</a> > <%=model.title %></div> 
