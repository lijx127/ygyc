...
<body style="margin: 0; min-width: 1200px;font-family:'微软雅黑'">
    <form id="form1" runat="server">
        ...
        <div class="middle">
            ...
            %>
            <div class="location">当前位置 > <a href="http://www.910class.com/ygyc/index.aspx">首页</a> > <%=Request.QueryString["channel"]=="wangqi"?"往期回顾":"培训课程" %></div> 
            <ul class="middle-search">
                ...
                <li class="clear"><span>培训地点：</span><a href="<%=PageControl.GetPageUrl(1, "city") %>" <%=GetCheck("city","") %>>不限</a>
                    <%
                        ...
                        if(!string.IsNullOrEmpty(Request.QueryString["city"])) {  dataTableCitys.DefaultView.RowFilter = "seo_title='1' or id='" + Request.QueryString["city"] + "'";}
                        else { dataTableCitys.DefaultView.RowFilter = "seo_title='1'"; }
