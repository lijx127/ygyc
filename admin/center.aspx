...
<div class="nlist-2">
  ...
  <ul>
    ...
    <li runat="server" visible="false">升级通知：<asp:Literal ID="LitUpgrade" runat="server"/></li>
  </ul>
</div>
<div class="line20"></div>

<div class="nlist-3" runat="server" visible="false">
  <ul>
...
<div class="nlist-4" runat="server" visible="false">
