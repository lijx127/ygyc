...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".upload-img").InitUploader({ filesize: "<%=siteConfig.imgsize %>", sendurl: "../../tools/upload_ajax.ashx", swf: "../../scripts/webuploader/uploader.swf", filetypes: "gif,jpg,png,bmp" });
        });
    </script>
</head>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <%if (ddlRoleId.SelectedValue == "3")
                { %>
            <dl>
                <dt>法定代表人名称</dt>
                <dd>
                    <asp:TextBox ID="txtLegalPersonName" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>法定代表人身份证（正面）</dt>
                <dd>
                    <asp:TextBox ID="txtLegalPersonCardId1" runat="server" CssClass="input normal upload-path" />
                    <div class="upload-box upload-img"></div>
                    <a href="<%=txtLegalPersonCardId1.Text %>" target="_blank">查看</a>
                </dd>
            </dl>
            <dl>
                <dt>法定代表人身份证（反面）</dt>
                <dd>
                    <asp:TextBox ID="txtLegalPersonCardId2" runat="server" CssClass="input normal upload-path" />
                    <div class="upload-box upload-img"></div>
                    <a href="<%=txtLegalPersonCardId2.Text %>" target="_blank">查看</a>
                </dd>
            </dl>
            <dl>
                <dt>企业执照</dt>
                <dd>
                    <asp:TextBox ID="txtLicense" runat="server" CssClass="input normal upload-path" />
                    <div class="upload-box upload-img"></div>
                    <a href="<%=txtLicense.Text %>" target="_blank">查看</a>
                </dd>
            </dl>
            <dl>
                <dt>所属类别</dt>
            ...
            <dl>
                <dt>固定电话</dt>
                <dd>
                    <asp:TextBox ID="txtPhone" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>邮箱</dt>
                <dd>
            ...
            <dl>
                <dt>办学规模</dt>
                <dd>
                    <asp:TextBox ID="txtSchooleScale" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>办学内容</dt>
                <dd>
                    <asp:TextBox ID="txtChooleContent" TextMode="MultiLine" Height="100" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <%} %>
        </div>
        <!--/内容-->
