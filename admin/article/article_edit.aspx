    ...
    <script type="text/javascript">
        $(function () {
            ...
            function uploadbackMain(txtObj) {
                $("#yulan").attr("src", $("#<%=txtImgUrl.ClientID%>").val());
            }
            ...
            //初始化上传控件
            $(".upload-img").InitUploader({ filesize: "<%=siteConfig.imgsize %>", sendurl: "../../tools/upload_ajax.ashx", swf: "../../scripts/webuploader/uploader.swf", filetypes: "<%=siteConfig.fileextension %>", back: uploadbackMain });
...
<body class="mainbody">
    <form id="form1" runat="server">
            ...
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <%if (channel_id != 14 && channel_id != 16)
                            {%>
        ...
        <div class="tab-content" style="min-height:600px">
            <%DTcms.Model.manager managerModel = GetAdminInfo();
                if (managerModel.role_id != 3)
                {%>
            <dl>
                <dt>所属类别</dt>
                <dd>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="upload-box upload-img"></div><br />
                    <%if (txtImgUrl.Text != "")
                        { %>
                    <img id="yulan" width="200" src="<%=txtImgUrl.Text %>">
                    <%} %>
                </dd>
            </dl>
            <%} %>
      ...
      <asp:Label ID="div_sell_price_tip" runat="server" CssClass="Validform_checktip" />
            ...
            <asp:Repeater ID="rptPrice" runat="server" Visible="false">
                <HeaderTemplate>
                    <dl>
                        <dt>会员价格</dt>
                        <dd>
        ...
        <div class="tab-content" style="display: none">
            ...
            <dl id="div_author" runat="server" visible="false">
                <dt>
                    <asp:Label ID="div_author_title" runat="server" Text="编辑" /></dt>
                <dd>
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-multi-checkbox">
                        ...
                        <asp:CheckBoxList ID="txtCallIndex" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:CheckBoxList>
                    </div>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    <div class="rule-multi-checkbox">
                        <asp:CheckBoxList ID="txtSeoTitle" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:CheckBoxList>
                    </div>
                </dd>
            </dl>
            <dl>
                <dt>培训开始时间</dt>
                <dd>
                    <asp:TextBox ID="txtSeoKeywords" runat="server" CssClass="input rule-date-input" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="/^\s*$|^\d{4}\-\d{1,2}\-\d{1,2}$/" errormsg="请选择正确的日期" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>培训结束时间</dt>
                <dd>
                    <asp:TextBox ID="txtSeoDescription" runat="server" CssClass="input rule-date-input" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="/^\s*$|^\d{4}\-\d{1,2}\-\d{1,2}$/" errormsg="请选择正确的日期" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
            <%} %>
            <%if (channel_id != 13)
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">不填写，则截取课程介绍的前255字符</span>
                </dd>
            </dl>
            <%} %>
            <%if (channel_id != 7)
